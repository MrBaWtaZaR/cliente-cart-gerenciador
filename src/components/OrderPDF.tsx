  ...
  return (
    <div className="pdf-page-container bg-white text-black font-[Poppins] text-xs"> {/* Base font size to text-xs for more space */}
      ...
      <div className="flex flex-row gap-x-4 mb-5"> {/* gap-x-4 para espaço entre os blocos */}
        ...
        <div className="w-[30%] p-3 border border-gray-200 rounded-md bg-gray-50 text-[10px]"> {/* text-[10px] para fonte menor nos blocos */}
        ...
        {hasTourInfo && (
          <div className="w-[30%] p-3 border border-gray-200 rounded-md bg-gray-50 text-[10px]">
